                            ...
                            @forelse ($rooms as $room)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <button wire:click="delete({{ $room->id }})" onclick="confirm('Apakah Kamu Yakin Ingin Menghapus?') || event.stopImmediatePropagation()" class="btn btn-sm btn-danger" title="Delete">
