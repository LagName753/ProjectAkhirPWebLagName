                            ...
                            @forelse ($beds as $bed)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button wire:click="delete({{ $bed->id }})" onclick="confirm('Apakah Kamu Yakin Ingin Menghapus?') || event.stopImmediatePropagation()" class="btn btn-sm btn-danger" title="Delete">
